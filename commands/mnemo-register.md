...
4. Print this line for the user to run themselves if they also use Codex — do not run it for them, and note that Codex has no equivalent of this registry, so this step is unavoidable there:
